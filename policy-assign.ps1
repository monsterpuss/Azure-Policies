...
$PolicyFile
Write-Host "Policy is applied to the subscription: $subName" -ForegroundColor Yellow
$policy = New-AzureRmPolicyDefinition -Name $PolicyName -Description $PolicyDescription -Policy $PolicyFile

Write-Host "Adding the Policy to the subscription" -ForegroundColor Yellow
